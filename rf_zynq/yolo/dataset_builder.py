...
class RFUAV_DatasetBuilder:
    def __init__(self, root_dir="e:/Myprojects/RF-Vision-UAV-Tracker/Drone RF Data", output_dir="e:/Myprojects/RF-Vision-UAV-Tracker/rf_yolo_dataset"):
    ...
    def process_iq_file(self, file_path, output_img_path):
        ...
        plt.imsave(output_img_path, waterfall_resized, cmap='hot', vmin=-70, vmax=30)
        ...
        for class_id, class_name in enumerate(self.classes):
            ...
            for iq_file in iq_files:
                ...
                with open(txt_path, "w") as f:
                    f.write("0 0.5 0.5 1.0 1.0\n") # 强制抹除无人机型号差异，全部归类为 0 号大类 (全域 UAV 信号)
